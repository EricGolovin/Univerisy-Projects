...
public class FractionOperation extends Operation<RationalFraction> {
    private int MIN_NUMERATOR_VALUE = 1;
    private int MAX_DENOMINATOR_VALUE = 99;
    ...
    public FractionOperation convertCollection() throws IncorrectLengthException {
