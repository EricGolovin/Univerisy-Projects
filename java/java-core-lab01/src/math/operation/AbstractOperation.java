...
public abstract class AbstractOperation<CollectionType> {
    public CollectionType[] array;
    public ArrayList<CollectionType> arrayList;
    public HashSet<CollectionType> hashSet;

    protected AbstractOperation(CollectionType[] array, ArrayList<CollectionType> arrayList, HashSet<CollectionType> hashSet) {
        this.array = array;
